...
$mail->SMTPAuth = true;
$mail->IsHTML(true);
$mail->Username = "example@example.com"; // put here your email to use sends message to users
$mail->Password = "examplepass"; // put here password to your email
$mail->setFrom('example@example.com', 'Quizzzzzzz'); 
